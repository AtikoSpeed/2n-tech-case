...
const formSchema = z.object({
  name: z.string().min(1, "Bir ad girin"),
  limit: z.string().min(1, "Bütçeyi girin"),
});
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Aylık Ortalama Gelir</FormLabel>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Gelir kategorisi..." {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <div className="flex justify-end space-x-2">
              ...
              <Button type="submit">
                {props.data ? "Update Category" : "Add Category"}
              </Button>
            </div>
          </form>
        </Form>
